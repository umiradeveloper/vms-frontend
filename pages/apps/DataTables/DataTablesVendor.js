...
export const GlobalFilterVendor = ({ filter, setFilter }) => {
	return (
...
const BasicTableVendor = ({column, datatable}) => {
	...
	return (
		<>
			<div className="d-flex">
				...
				<GlobalFilterVendor filter={globalFilter} setFilter={setGlobalFilter} />
			</div>
			<table
				{...getTableProps()}
...
export default dynamic(() => Promise.resolve(BasicTableVendor), { ssr: false });
