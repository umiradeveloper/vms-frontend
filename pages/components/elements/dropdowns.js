...
import { AlignmentButtons, AutocloseButtons, CustomButtons, SingleButtons, SplitButtonsdata } from "../../../shared/data/elements/dropdownsdata";
import { GhostButtons, OutlineButtons } from "../../../shared/data/elements/buttonsdata";
import { dropdown1, dropdown10, dropdown11, dropdown12, dropdown13, dropdown14, dropdown15, dropdown16, dropdown17, dropdown18, dropdown19, dropdown2, dropdown20, dropdown21, dropdown22, dropdown23, dropdown24, dropdown25, dropdown26, dropdown27, dropdown28, dropdown29, dropdown3, dropdown4, dropdown5, dropdown6, dropdown7, dropdown8, dropdown9 } from "../../../shared/data/prismdata/uielementsprim";
	...
	return (
		<>
					...
					<ShowCode title="Dark Dropdowns" customCardClass="custom-card" customCardBodyClass="" code={dropdown20}>
						...
						<Dropdown>
							...
							<Dropdown.Menu as="ul" className="dropdown-menu dropdown-menu-dark">
								<Dropdown.Item as="li" className="text-white" href="#!">Action</Dropdown.Item>
								<Dropdown.Item as="li" className="text-white" href="#!">Another action</Dropdown.Item>
								<Dropdown.Item as="li" className="text-white" href="#!">Something else here</Dropdown.Item>
							</Dropdown.Menu>
						</Dropdown>
			...
			<Row>
				...
				<Col xxl={4}>
					<ShowCode title="Responsive alignment end" customCardClass="custom-card" customCardBodyClass="responsive-dropdown" code={dropdown22}>
				...
				<Col xxl={4}>
					<ShowCode title="Responsive alignment left" customCardClass="custom-card" customCardBodyClass="responsive-dropdown" code={dropdown23}>
