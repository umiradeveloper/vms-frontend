...
import { Card, Col, ProgressBar, Row, Table, Dropdown } from "react-bootstrap";
import { ProductsDetails, RecentOrder, RevenueChart, WorldMap } from "../../../shared/data/ecommerce/edashboard";
...
const ECDashboard = () => {
	...
	return (
		<Fragment>
			<Seo title={"Welcome To Dashboard"} />
						...
						<Card.Body>
							<div className="card-order ">
								...
								<h2 className="text-end card-item-icon card-icon">
									...
									<span className="fw-semibold">3,672</span>
								</h2>
								<p className="mb-0 mt-4 text-muted">Monthly users<span className="float-end">50%</span> </p>
							</div>
						</Card.Body>
					</Card>
				</Col>
						...
						<Card.Body>
							<div className="card-order">
								...
								<h2 className="text-end">
									...
									<span className="fw-semibold">$89,265</span>
								</h2>
								<p className="mb-0 mt-4 text-muted"> Monthly Income<span className="float-end">$7,893</span></p>
							</div>
						</Card.Body>
					</Card>
				</Col>
						...
						<Card.Body>
							<div className="card-order">
								...
								<h2 className="text-end">
									...
									<span className="fw-semibold">$23,987</span>
								</h2>
								<p className="mb-0 mt-4 text-muted"> Monthly Profit<span className="float-end">$4,678</span> </p>
							</div>
						</Card.Body>
					</Card>
				</Col>
						...
						<Card.Body>
							<div className="card-order">
								...
								<h2 className="text-end">
									...
									<span className="fw-semibold">46,486</span>
								</h2>
								<p className="mb-0 mt-4 text-muted"> Monthly Sales<span className="float-end">3,756</span> </p>
							</div>
						</Card.Body>
					</Card>
				</Col>
			...
			<Row className="row-sm">
				...
				<Col xxl={3} xl={6} md={12} lg={12}>
					<Card className="custom-card">
						...
						<Card.Body className="sales-product-info p-0">
							...
							<div className="row sales-product-infomation pb-0 mb-0 mx-auto wd-100p">
								<div className="col-md-6 col justify-content-center text-center">
									...
									<h3 className="mb-1 fw-semibold">5238</h3>
								...
								<div className="col-md-6 col text-center float-end">
									...
									<h3 className="mb-1 fw-semibold">3467</h3>
									<div className="d-flex justify-content-center ">
										<p className="text-muted">Last 6 months</p>
									</div>
								</div>
							...
							<ul className="visitor mb-0 d-block users-images list-unstyled list-unstyled-border ht-340">
								...
								<li className="media d-flex mb-2">
									...
									<div className="media-body mb-1">
										...
										<h5 className="media-title fs-15 mb-0">Rosien</h5>
										<small className="text-muted">sed do eiusmod </small>
									</div>
								</li>
							</ul>
						...
						<div className="product-timeline card-body pt-3 mt-1">
							<ul className="timeline-1 mb-0">
								<li className="mt-0">
									...
									<span className="fw-medium mb-4 fs-14 ">
										Total Products
									</span>
				...
				<div className="col-xxl-6 col-xl-12 col-md-12 col-lg-12">
					<Card className="custom-card top-inquiries overflow-hidden">
						...
						<Card.Body className="">
							<Row className="" >
							<Col xl={8} className="">
							<div id="users-map" className=' d-flex gap-md-6 overflow-auto jvm-container'>
					...
					<Card className=" custom-card overflow-hidden">
						<Card.Header className="border-bottom-0 d-flex">
							<div>
								...
								<p className="fs-12 mb-3 text-muted mb-0">
							...
							<Dropdown className="card-options float-end no-caret">
								<Dropdown.Toggle
									className="me-0 text-default no-caret border-0"
									role="button"
									variant="default"
									...
									<tbody>
										{ProductsDetails.map((Items, index) => (
											<tr key={index} data-index={index}>
												...
												<td className={`d-flex my-auto ${Items.class}`} >
													<img
														src={Items.Productname}
														alt=""
														className="ht-40 wd-40 me-3"
													/>
													<span className="my-auto w-210">{Items.Producttext}</span>
												</td>
												<td>
						...
						<div className="card-body pt-0">
							<div className="border">
								<div className="list-group projects-list pt-0 pb-0 ps-0 pe-0">
									<Link href="#!" className="list-group-item list-group-item-action flex-column align-items-start border-0">
										<div className="d-flex w-100 justify-content-between">
											<h6 className="mb-1 fw-medium">Order Picking</h6>
											<h6 className="mb-0 fw-semibold fs-15">3,876</h6> </div>
									...
									<Link href="#!" className="list-group-item list-group-item-action flex-column align-items-start border-bottom-0  border-start-0 border-end-0 border-top">
										<div className="d-flex w-100 justify-content-between">
											...
											<h6 className="mb-0 fw-semibold fs-15">2,178</h6> </div>
									...
									<Link href="#!" className="list-group-item list-group-item-action flex-column align-items-start border-bottom-0  border-start-0 border-end-0 border-top">
										<div className="d-flex w-100 justify-content-between">
											...
											<h6 className="mb-0 fw-semibold fs-15">1,367</h6> </div>
									...
									<Link href="#!" className="list-group-item list-group-item-action flex-column align-items-start border-bottom-0  border-start-0 border-end-0 border-top">
										<div className="d-flex w-100 justify-content-between">
											...
											<h6 className="mb-0 fw-semibold fs-15">678</h6> </div>
									...
									<Link href="#!" className="list-group-item list-group-item-action flex-column align-items-start border-start-0 border-end-0 border-0 border-top">
										<div className="d-flex w-100 justify-content-between">
											<h6 className="mb-1 fw-medium">Other</h6>
											<h6 className="mb-0 fw-semibold fs-15">5,678</h6> </div>
