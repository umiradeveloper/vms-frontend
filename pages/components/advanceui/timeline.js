...
const Timeline = () => {
	return (
		<Fragment>
			<Seo title={"Timeline"} />
			<PageHeader title='Timeline' item='Advanced Ui' active_item='Timeline' />
								...
								<div className="timeline-wrapper timeline-wrapper-primary">
									...
									<div className="timeline-panel">
										...
										<div className="timeline-footer d-flex align-items-center flex-wrap">
											...
											<span>19</span>
											<span className="ms-auto"><i className="fe fe-calendar text-muted me-1"></i>19 Oct 2020</span>
										</div>
									</div>
								</div>
								<div className="timeline-wrapper timeline-inverted timeline-wrapper-secondary">
									...
									<div className="timeline-panel">
										...
										<div className="timeline-footer d-flex align-items-center flex-wrap">
											<i className="fe fe-heart  text-muted me-1"></i>
											<span>25</span>
											<span className="ms-auto"><i className="fe fe-calendar text-muted me-1"></i>10th Oct 2020</span>
										</div>
									</div>
								</div>
								<div className="timeline-wrapper timeline-wrapper-info">
									...
									<div className="timeline-panel">
										...
										<div className="timeline-footer d-flex align-items-center flex-wrap">
											<i className="fe fe-heart  text-muted me-1"></i>
											<span>19</span>
											<span className="ms-auto"><i className="fe fe-calendar text-muted me-1"></i>5th Oct 2020</span>
										</div>
									</div>
								</div>
								<div className="timeline-wrapper timeline-inverted timeline-wrapper-danger">
									...
									<div className="timeline-panel">
										...
										<div className="timeline-body">
											...
											<img src={"../../../assets/images/media/media-72.jpg"} className="mb-3" alt="img" />
										</div>
										<div className="timeline-footer d-flex align-items-center flex-wrap">
											<i className="fe fe-heart  text-muted me-1"></i>
											<span>19</span>
											<span className="ms-auto"><i className="fe fe-calendar text-muted me-1"></i>27th Sep 2017</span>
										</div>
									</div>
								</div>
								<div className="timeline-wrapper timeline-wrapper-success">
									...
									<div className="timeline-panel">
										...
										<div className="timeline-body">
											...
											<a className="btn ripple btn-primary mb-3">Read more</a>
										</div>
										<div className="timeline-footer d-flex align-items-center flex-wrap">
											<i className="fe fe-heart  text-muted me-1"></i>
											<span>25</span>
											<span className="ms-auto"><i className="fe fe-calendar text-muted me-1"></i>25th Sep 2017</span>
										</div>
									</div>
								</div>
									...
									<div className="timeline-panel">
										...
										<div className="timeline-body">
											<div className="embed-responsive embed-responsive-16by9 mb-3">
												<iframe className="embed-responsive-item" src="https://www.youtube.com/embed/XZmGGAbHqa0?rel=0&amp;controls=0&amp;showinfo=0"
										...
										<div className="timeline-footer d-flex align-items-center flex-wrap">
											<i className="fe fe-heart  text-muted me-1"></i>
											<span>32</span>
											<span className="ms-auto"><i className="fe fe-calendar text-muted me-1"></i>19th Sep 2017</span>
										</div>
									</div>
								</div>
								<div className="timeline-wrapper timeline-wrapper-dark">
									...
									<div className="timeline-panel">
										...
										<div className="timeline-footer d-flex align-items-center flex-wrap">
											<i className="fe fe-heart text-muted me-1"></i>
											<span>26</span>
											<span className="ms-auto"><i className="fe fe-calendar text-muted me-1"></i>15th Sep 2017</span>
										</div>
									</div>
								</div>
							</div>
