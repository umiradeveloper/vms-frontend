...
import { Multipleselectdata, Multipleselectdata1, Optionwithnosearch, SingleGroup, SingleGroup1 } from "../../../../shared/data/forms/formelements/formselectdata";
import Seo from "../../../../shared/layout-components/seo/seo";
import ShowCode from "../../../../shared/showcode/showcode";
import { formselect1, formselect2, formselect3, formselect4, formselect5, formselect6 } from "../../../../shared/data/prismdata/formsdata";
							...
							<Card className="custom-card">
								...
								<Card.Body>
									...
									<div className="choices mb-4">
										<Select isMulti name="colors" options={Multipleselectdata} className="default basic-multi-select custom-multi "
									...
									<div className="choices mb-4">
										<Select isMulti name="colors" options={Multipleselectdata1} className="basic-multi-select custom-multi"
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Multiple Attribute Select" customCardClass="custom-card" customCardBodyClass="" code={formselect5}>
						<Form.Select multiple className="form-select" aria-label="multiple select example" defaultValue={["0"]}>
				...
				<Col xl={6}>
					<ShowCode title="Using Size Attribute" customCardClass="custom-card" customCardBodyClass="" code={formselect6}>
						<Form.Select multiple className="form-select" htmlSize={4} aria-label="size 3 select example" defaultValue={["0"]}>
							<option className='selected' value="0">Open this select menu</option>
							<option value="1">One</option>
							<option value="2">Two</option>
							<option value="3">Three</option>
