	...
	constructor(props) {
		...
		this.state = {
			...
			options: {
				...
				colors: ["var(--primary-color)", "#01b8ff", "#f5b849", "#fd7889", "#49b6f5"],
				grid: {
					borderColor: "#f2f5f7",
				},
				title: {
	...
	constructor(props) {
		...
		this.state = {
			...
			options: {
				...
				colors: ["var(--primary-color)", "#01b8ff", "#f5b849", "#fd7889", "#49b6f5", "#a65e76", "#5b67c7", "#a65e9a",
					"#26bf94", "#01b8ff"
				],
				grid: {
					borderColor: "#f2f5f7",
	...
	constructor(props) {
		...
		this.state = {
			...
			options: {
				...
				colors: ["var(--primary-color)", "#01b8ff", "#f5b849", "#49b6f5"],
				title: {
