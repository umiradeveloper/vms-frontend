							...
							<Card.Body>
								<div className="">
									<div className="d-grid">
										<Link className="btn ripple btn-primary btn-compose" href="/components/apps/mail/mailcomposed/">Compose</Link>
									</div>
										...
										<div className="media-body text-gray fs-inverse">
											<div className="float-end d-none d-md-flex fs-15 profile-dropdown">
												...
												<Dropdown className="me-2">
													<Dropdown.Toggle className='p-0 border-0' href="#!" data-bs-toggle="dropdown" variant="" role="button" aria-haspopup="true" aria-expanded="false">
														<OverlayTrigger
															placement="top"
															// className="me-3 fs-inverse"
