					...
					<Card className="custom-card">
						...
						<Card.Body>
							<Nav className="nav nav-tabs border-0" as="ul">
								<Nav.Item as="li"> <Nav.Link active>Active</Nav.Link> </Nav.Item>
								<Nav.Item as="li" > <Nav.Link>Link</Nav.Link> </Nav.Item>
								<Nav.Item as="li"> <Nav.Link  >Link</Nav.Link> </Nav.Item>
								<Nav.Item as="li"> <Nav.Link disabled >Disabled</Nav.Link> </Nav.Item>
							</Nav>
						</Card.Body>
					</Card>
				</Col>
					...
					<Card className="custom-card">
						...
						<Card.Body>
							<Tab.Container defaultActiveKey="first">
								<Nav className="nav-tabs mb-3 border-0" id="myTab" role="tablist" defaultActiveKey="first">
									<Nav.Item><Nav.Link href="#home1" eventKey="first">Home</Nav.Link> </Nav.Item>
									<Nav.Item><Nav.Link href="#about1" eventKey="second">About</Nav.Link> </Nav.Item>
									<Nav.Item><Nav.Link href="#service1" eventKey="third">Services</Nav.Link> </Nav.Item>
									<Nav.Item><Nav.Link href="#license1" eventKey="fourth">License</Nav.Link> </Nav.Item>
								</Nav>
								<Tab.Content>
									...
									<Tab.Pane className="text-muted" id="license1" role="tabpanel"
					...
					<Card className="custom-card">
						...
						<Card.Body>
							<Tab.Container id="left-tabs-example" defaultActiveKey="third">
								<Nav className="nav-tabs mb-3 nav-justified nav-style-1 d-sm-flex d-block" role="tablist" defaultActiveKey="third">
									<Nav.Item> <Nav.Link href="#home1-justified" eventKey="first" >Home</Nav.Link> </Nav.Item>
									<Nav.Item> <Nav.Link href="#about1-justified" eventKey="second">About</Nav.Link> </Nav.Item>
									<Nav.Item> <Nav.Link eventKey="third" href="#service1-justified" >Services</Nav.Link> </Nav.Item>
									<Nav.Item> <Nav.Link href="#license1-justified" eventKey="fourth">License</Nav.Link> </Nav.Item>
								</Nav>
			...
			<Row className="row-sm">
						...
						<Card.Body>
							<Tab.Container id="left-tabs-example" defaultActiveKey="second">
								<Nav className="nav nav-style-1 nav-pills mb-3" defaultActiveKey="first">
									...
									<Nav.Link href="#nav-orders" eventKey="third" aria-selected="false">Orders<span className="badge bg-success ms-1 rounded-pill">4</span></Nav.Link>
				...
				<Col xl={6}>
					<Card className="custom-card">
						...
						<Card.Body>
							<Tab.Container id="left-tabs-example" defaultActiveKey="second">
								<Nav className="nav-style-6 nav-pills mb-3 nav-justified d-sm-flex d-block" role="tablist" defaultActiveKey="first">
									<Nav.Link eventKey="first" href="#nav-products-justified" >Products</Nav.Link>
									<Nav.Link eventKey="second" href="#nav-cart-justified">Cart <span className="badge bg-info-transparent ms-1">Full</span></Nav.Link>
									<Nav.Link eventKey="third" href="#nav-orders-justified" aria-selected="false">Orders </Nav.Link>
									<Nav.Link eventKey="fourth" href="#nav-offers-justified">Offers <span className="badge bg-warning-transparent ms-1">7</span></Nav.Link>
								</Nav>
								<Tab.Content id="myTabContent">
									<Tab.Pane className="text-muted" id="nav-products-justified" role="tabpanel" eventKey="first">
									...
									<Tab.Pane className="text-muted" id="nav-cart-justified" eventKey="second">
									...
									<Tab.Pane className="text-muted" id="nav-orders-justified" role="tabpanel" eventKey="third">
									...
									<Tab.Pane className="text-muted" id="nav-offers-justified" role="tabpanel" eventKey="fourth">
					...
					<Card className="custom-card">
						...
						<Card.Body>
							<Tab.Container id="left-tabs-example" defaultActiveKey="first">
								<Row>
									<Col xl={3}>
										<Nav className="nav-tabs flex-column nav-style-4" role="tablist" defaultActiveKey="first">
											<Nav.Item> <Nav.Link href="#home-vertical" eventKey="first">Home</Nav.Link> </Nav.Item>
											<Nav.Item> <Nav.Link eventKey="second" href="#about-vertical">About</Nav.Link> </Nav.Item>
											<Nav.Item> <Nav.Link href="#services-vertical" eventKey="third">Services</Nav.Link> </Nav.Item>
											<Nav.Item> <Nav.Link href="#contacts-vertical" eventKey="fourth" >Contacts</Nav.Link> </Nav.Item>
										</Nav>
									</Col>
									<Col xl={9}>
										<Tab.Content>
											<Tab.Pane className="text-muted" id="home-vertical" role="tabpanel" eventKey="first">
											...
											<Tab.Pane className="text-muted" id="about-vertical" role="tabpanel" eventKey="second">
											...
											<Tab.Pane className="text-muted" id="services-vertical" role="tabpanel" eventKey="third">
											...
											<Tab.Pane className="text-muted" id="contacts-vertical" role="tabpanel" eventKey="fourth">
					...
					<Card className="custom-card">
						...
						<Card.Body>
							<Tab.Container id="left-tabs-example" defaultActiveKey="third">
								<Row>
									<Col xl={3}>
										<Nav className="nav-tabs flex-column nav-style-5" role="tablist" defaultActiveKey="third">
											<Nav.Item> <Nav.Link href="#home-vertical-link" eventKey="first"> <i className="ri-home-smile-line me-2 align-middle d-inline-block"></i>Home</Nav.Link> </Nav.Item>
											<Nav.Item> <Nav.Link eventKey="second" href="#about-vertical-link"> <i className="ri-archive-drawer-line me-2 align-middle d-inline-block"></i>About</Nav.Link> </Nav.Item>
											<Nav.Item> <Nav.Link eventKey="third" href="#services-vertical-link"> <i className="ri-bank-line me-2 align-middle d-inline-block"></i>Services</Nav.Link> </Nav.Item>
											<Nav.Item> <Nav.Link eventKey="fourth" href="#contacts-vertical-link"> <i className="ri-contacts-book-2-line me-2 align-middle d-inline-block"></i>Contacts</Nav.Link> </Nav.Item>
										</Nav>
									</Col>
									<Col xl={9}>
										<Tab.Content>
											<Tab.Pane className="text-muted" id="home-vertical-link" eventKey="first"
												role="tabpanel">
												How hotel deals can help you live a better life. <b>How celebrity
													cruises</b> aren't as bad as you think. How cultural solutions
												can help you predict the future. How to cheat at dog friendly hotels
											...
											<Tab.Pane className="text-muted" id="about-vertical-link" eventKey="second"
												role="tabpanel">
												How travel coupons make you a better lover. Why cultural solutions
												are the new black. Why mom was right about travel insurances. How
												family trip ideas can help you predict the future. <b>How carnival
											...
											<Tab.Pane className="show  text-muted" id="services-vertical-link" eventKey="third"
												role="tabpanel">
												Unbelievable healthy snack success stories. 12 facts about safe food
												handling tips that will impress your friends. Restaurant weeks by
											...
											<Tab.Pane className="text-muted" id="contacts-vertical-link" eventKey="fourth"
												role="tabpanel">
												Why delicious magazines are killing you. Why our world would end if
												restaurants disappeared. Why restaurants are on crack about
												restaurants. How restaurants are making the world a better place. 8
			...
			<Row className="row-sm">
						...
						<Card.Body>
							<Tab.Container defaultActiveKey="first">
								<Nav className="nav-tabs tab-style-1 d-sm-flex d-block" defaultActiveKey="first">
									<Nav.Item> <Nav.Link eventKey="first" href="#orders">Orders</Nav.Link> </Nav.Item>
									<Nav.Item> <Nav.Link eventKey="second" href="#accepted">Accepted</Nav.Link> </Nav.Item>
									<Nav.Item> <Nav.Link eventKey="third" href="#declined">Declined</Nav.Link> </Nav.Item>
								</Nav>
								<Tab.Content>
									<Tab.Pane id="orders" role="tabpanel" eventKey="first">
					...
					<Card className="custom-card">
						...
						<Card.Body>
							<Tab.Container defaultActiveKey="second">
								<Nav variant="pills" className="nav-tabs tab-style-2 nav-justified mb-3 d-sm-flex d-block" id="myTab1" role="tablist" defaultActiveKey="first">
									<Nav.Item> <Nav.Link eventKey="first" id="order-tab" type="button" ><i className="ri-gift-line me-1 align-middle"></i>Ordered</Nav.Link> </Nav.Item>
									<Nav.Item> <Nav.Link eventKey="second" id="confirmed-tab" type="button" ><i className="ri-check-double-line me-1 align-middle"></i>Confirmed</Nav.Link> </Nav.Item>
									<Nav.Item> <Nav.Link eventKey="third" id="shipped-tab" type="button" ><i className="ri-shopping-bag-3-line me-1 align-middle"></i>Shipped</Nav.Link> </Nav.Item>
									<Nav.Item> <Nav.Link eventKey="fourth" id="delivered-tab" type="button" ><i className="ri-truck-line me-1 align-middle"></i>Delivery</Nav.Link> </Nav.Item>
								</Nav>
								<Tab.Content id="myTabContent">
									<Tab.Pane className="fade text-muted p-0" id="order-tab-pane" role="tabpanel" eventKey="first" aria-labelledby="home-tab" tabIndex={0}>
									...
									<Tab.Pane className="fade text-muted p-0" id="confirm-tab-pane" eventKey="second" role="tabpanel" aria-labelledby="profile-tab" tabIndex={0}>
										<ul className="ps-3 mb-0">
											<li className="mb-2">
									...
									<Tab.Pane className="fade text-muted p-0" id="shipped-tab-pane" role="tabpanel" eventKey="third" aria-labelledby="contact-tab" tabIndex={0}>
										<ul className="ps-3 mb-0">
											<li className="mb-2">
									...
									<Tab.Pane className="fade text-muted p-0" id="delivered-tab-pane" role="tabpanel" tabIndex={0} eventKey="fourth">
				...
				<Col xxl={3} xl={6}>
					<Card className="custom-card">
						...
						<Card.Body>
							<Tab.Container defaultActiveKey="first">
								<Nav variant="pills" className="nav-tabs justify-content-center mb-5 tab-style-3" id="myTab2" role="tablist" defaultActiveKey="first">
									<Nav.Item> <Nav.Link eventKey="first" className="home py-1" id="home-tab" type="button">Home</Nav.Link> </Nav.Item>
									<Nav.Item> <Nav.Link eventKey="second" className="about py-1" id="profile-tab" type="button" >Profile</Nav.Link> </Nav.Item>
									<Nav.Item> <Nav.Link eventKey="third" className="services py-1" id="contact-tab" type="button" >About</Nav.Link> </Nav.Item>
								</Nav>
							...
							<div className="example">
								<Tab.Container defaultActiveKey="first">
									...
									<Tab.Content className="tab-content" id="tab-style-4">
										<Tab.Pane className="tab-pane p-3 show " id="nav-home1" role="tabpanel" eventKey="first"
										...
										<Tab.Pane className="tab-pane p-3" id="nav-profile1" role="tabpanel" eventKey="second"
										...
										<Tab.Pane className="tab-pane p-3" id="nav-contact1" role="tabpanel" eventKey="third"
							...
							<div className="example">
								<Tab.Container defaultActiveKey="first">
									...
									<Tab.Content className="tab-content" id="myTabContent2">
										<Tab.Pane className="rounded-0 fade show  p-0 border-bottom-0" id="products-tab-pane" eventKey="first"
										...
										<Tab.Pane className="rounded-0 fade" id="sales-tab-pane" role="tabpanel" eventKey="second"
										...
										<Tab.Pane className="rounded-0 fade" id="profit-tab-pane" role="tabpanel" eventKey="third"
										...
										<Tab.Pane className="rounded-0 fade" id="expenses-tab-pane" role="tabpanel" eventKey="fourth"
							...
							<div className="example">
								<Tab.Container id="left-tabs-example" defaultActiveKey="first">
									<Row>
										...
										<Col xxl={8} xl={8} sm={9}>
											<Tab.Content id="v-pills-tabContent" className='mt-3 mt-md-0'>
													...
													<div className="d-sm-flex">
														...
														<div>
															<div className="my-md-auto mt-4 ms-md-3">
																...
																<p className="text-muted ms-0 mb-2 pb-2 "> <span className="me-3 d-inline-flex align-items-center "><i
																	className="far fa-address-card me-2"></i>Ui/Ux
																	Developer</span> <span className="me-3 d-inline-flex align-items-center "><i
				...
				<Col xl={6}>
					<Card className="custom-card">
						...
						<Card.Body>
							<div className="example">
								<Tab.Container id="left-tabs-example" defaultActiveKey="first">
									<Nav variant='pills' className="nav nav-tabs mb-3 border-0" role="tablist" defaultActiveKey="first">
										<Nav.Item>
								...
								<Tab.Container id="left-tabs-example" defaultActiveKey="first">
									<Nav variant='pills' className="nav nav-pills mb-3" role="tablist" defaultActiveKey="first">
										...
										<Dropdown className="nav-item dropdown">
											...
											<Dropdown.Menu>
												<Dropdown.Item data-bs-toggle="tab" role="tab" href="#pill-wishlist" eventKey="second"
...
Navs$tabs.layout = "Contentlayout";
