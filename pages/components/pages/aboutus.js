...
const Aboutus = () => {
	return (
		<Fragment>
			<Seo title={"About Us"} />
			<PageHeader title='About Us' item='Pages' active_item='About Us' />
			<Container>
				...
				<Row className="row-sm">
					<Col xl={12}>
						<Card className="custom-card">
							<img src={"../../../assets/images/media/jobs-landing/blog/16.jpg"} alt="img" className="rounded-3" />
						</Card>
					</Col>
				</Row>
				<Row className="row-sm">
						...
						<Row className="row-sm">
							<Col xl={6} lg={6} md={12} sm={12}>
								<div className="mt-5">
									...
									<Link href="#!" className="btn ripple btn-primary btn-sm" role="button">Contact Us</Link>
								</div>
							</Col>
							<Col xl={6} lg={6} md={12} sm={12}>
								<div className="text-xl-end text-center">
									<img src={"../../../assets/images/pngs/30.png"} alt="img" className="rounded-5" />
								</div>
							</Col>
						</Row>
					</Col>
								...
								<div className="d-flex mb-4">
									<div>
										...
										>
											...
											<path
												fill="#6d7ee5"
												d="M15.70056,12.71338C14.68073,13.5155,13.39789,13.99847,12,14c-1.39984,0-2.68463-0.48334-3.70532-1.28693
													...
													C21.51917,17.15436,19.06299,14.05371,15.70056,12.71338z"
											/>
										</svg>
									</div>
									<div className="ms-4">
										<h5 className="tx-medium">Hardworking !</h5>
										<p>
											Lorem ipsum dolor sit amet consectetur adipisicing elit.
								...
								<div className="d-flex mb-4">
									<div>
										...
										>
											<path
												fill="#6d7ee5"
												d="M18.30652,12.22144C17.42371,13.00647,16.27399,13.49854,15,13.5c-0.27161,0-0.53668-0.02515-0.79553-0.06805
													...
													C23,16.26233,21.07294,13.48047,18.30652,12.22144z"
											/>
											<path
												fill="#d8d8ff"
												d="M9,13.5c-2.76142,0-5-2.23858-5-5s2.23858-5,5-5s5,2.23858,5,5C13.99676,11.26008,11.76008,13.49676,9,13.5z"
											/>
											<path
												fill="#d8d8ff"
												d="M9,13.5c-2.76142,0-5-2.23858-5-5s2.23858-5,5-5s5,2.23858,5,5C13.99676,11.26008,11.76008,13.49676,9,13.5z"
											...
											<path
												fill="#b2b1ff"
												d="M12.30652,12.22144C11.42371,13.00647,10.27399,13.49854,9,13.5c-1.27496,0-2.42566-0.49194-3.30884-1.27747
												C2.92603,13.48206,1,16.26324,1,19.5c0,0.00018,0,0.00037,0,0.00055C1.00012,20.05267,1.44788,20.50012,2,20.5h14
												c0.00018,0,0.00037,0,0.00055,0c0.55212-0.00012,0.99957-0.44788,0.99945-1C17,16.26233,15.07294,13.48047,12.30652,12.22144z"
											/>
											<path
												fill="#8c8aff"
												d="M15,3.5c-1.13092,0-2.16235,0.38959-3,1.02264c0.27319,0.20648,0.52069,0.43982,0.74603,0.69696
												...
												C14.46332,13.47485,14.72839,13.5,15,13.5c2.76007-0.00323,4.99677-2.23993,5-5C20,5.73859,17.76141,3.5,15,3.5z"
											/>
										</svg>
									</div>
									<div className="ms-4">
								...
								<div className="d-flex">
									<div>
										<svg
											...
											viewBox="0 0 24 24"
										>
											<circle cx="12" cy="9.25" r="6" fill="#c1c0ff" />
											<path
												fill="#6d7ee5"
				...
				<Row className="row-sm">
					<Col xl={3} lg={6} md={6} sm={6}>
						<Card className="custom-card bg-primary-transparent">
							<Card.Body>
								<div className="counter-status">
									<div className="text-center mb-1">
										<svg
											className="statistics-icon bg-secondary-transparent"
											xmlns="http://www.w3.org/2000/svg"
											enableBackground="new 0 0 24 24"
											viewBox="0 0 24 24"
										>
											<circle cx="10" cy="8.5" r="5" fill="#fb8dbe" />
											<path
												fill="#f1388b"
									...
									<div className="text-center mb-1">
										<h2 className="counter mb-2 tx-normal">5,432</h2>
										<h6 className="mb-0 text-muted tx-normal">Total Customers</h6>
									</div>
								</div>
							</Card.Body>
						</Card>
						...
						<Card className="custom-card bg-primary-transparent">
							<Card.Body>
								<div className="counter-status">
									<div className="text-center mb-1">
										<svg
											className="statistics-icon bg-warning-transparent"
											xmlns="http://www.w3.org/2000/svg"
											enableBackground="new 0 0 24 24"
											viewBox="0 0 24 24"
										>
									...
									<div className="text-center mb-1">
										<h2 className="counter mb-2 tx-normal">500</h2>
										<h6 className="mb-0 text-muted tx-normal">Employees</h6>
									</div>
								</div>
							</Card.Body>
						</Card>
						...
						<Card className="custom-card bg-primary-transparent">
							<Card.Body>
								<div className="counter-status">
									<div className="text-center mb-1">
										<svg
											className="statistics-icon bg-danger-transparent"
											xmlns="http://www.w3.org/2000/svg"
											viewBox="0 0 24 24"
										>
											<path
									...
									<div className="text-center mb-1">
										<h2 className="counter mb-2 tx-normal">298</h2>
										<h6 className="mb-0 text-muted tx-normal">
											Completed Projects
										</h6>
									</div>
								</div>
						...
						<Card className="custom-card bg-primary-transparent">
							<Card.Body>
								<div className="counter-status">
									<div className="text-center mb-1">
										<svg
											className="statistics-icon bg-info-transparent"
											xmlns="http://www.w3.org/2000/svg"
											enableBackground="new 0 0 24 24"
											viewBox="0 0 24 24"
										>
											<circle cx="12" cy="9.25" r="6" fill="#6dd6ff" />
											<path
												fill="#01b8ff"
												d="M19.57391,17.01288L17.00854,12.56l-0.00873,0.00433C15.92511,14.18231,14.08795,15.25,12,15.25c-0.1286,0-0.25439-0.01123-0.38098-0.01923l0.38953,0.66925l2.37408,4.11218c0.13806,0.23914,0.44385,0.32111,0.68304,0.18304c0.07391-0.04266,0.13562-0.10358,0.17938-0.17682l1.32349-2.21844l2.57941-0.0376c0.27612-0.00397,0.4967-0.23108,0.49268-0.5072C19.6394,17.17004,19.61646,17.08667,19.57391,17.01288z"
											/>
									...
									<div className="text-center mb-1">
										<h2 className="counter mb-2 tx-normal">180</h2>
										<h6 className="mb-0 text-muted tx-normal">Awards won</h6>
									</div>
								</div>
							</Card.Body>
						</Card>
						...
						<Card className="custom-card our-team">
							<Card.Body>
								...
								<div className="text-center mt-3">
									<Link href="#!"> <h5 className="pro-user-username text-dark mt-2 mb-0"> Dennis Trexy </h5> </Link>
								...
								<div className="text-center mt-3">
									<Link href="#!" className="btn btn-sm ripple bg-primary-transparent text-primary rounded-circle me-1"> <i className="mdi mdi-facebook"></i></Link>
									<Link href="#!" className="btn btn-sm ripple bg-danger-transparent text-danger rounded-circle me-1"> <i className="mdi mdi-google"></i> </Link>
									<Link href="#!" className="btn btn-sm ripple bg-info-transparent text-info rounded-circle"> <i className="ri-twitter-x-fill"></i> </Link>
								</div>
							</Card.Body>
						</Card>
					</Col>
					<Col xl={3} lg={6} md={6} sm={6}>
						<Card className="custom-card our-team">
							<Card.Body>
								...
								<div className="text-center mt-3">
									<Link href="#!"> <h5 className="pro-user-username text-dark mt-2 mb-0">Benedict Vallone</h5> </Link>
									<p className="pro-user-desc text-muted mb-1">Web Designer</p>
									<div className="text-center tx-14 mb-3">
										Lorem ipsum dolor, sit amet consectetur adipisicing elit.
										Quibusdam !
									</div>
					...
					<Col xl={3} lg={6} md={6} sm={6}>
						<Card className="custom-card our-team">
							<Card.Body>
								...
								<div className="text-center mt-3">
									<Link href="#!"> <h5 className="pro-user-username text-dark mt-2 mb-0"> Robbie Ruder </h5> </Link>
									<p className="pro-user-desc text-muted mb-1">Web Developer</p>
									<div className="text-center tx-14 mb-3">
										Lorem ipsum dolor, sit amet consectetur adipisicing elit.
										Quibusdam !
					...
					<Col xl={3} lg={6} md={6} sm={6}>
						<Card className="custom-card our-team">
							<Card.Body>
								...
								<div className="text-center mt-3">
									<Link href="#!"> <h5 className="pro-user-username text-dark mt-2 mb-0"> Mariane Galeon </h5> </Link>
									<p className="pro-user-desc text-muted mb-1">Web Designer</p>
									<div className="text-center tx-14 mb-3">
										Lorem ipsum dolor, sit amet consectetur adipisicing elit.
										Quibusdam !
