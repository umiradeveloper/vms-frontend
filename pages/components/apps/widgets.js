...
import { Visitors } from "../../../shared/data/apps/widgetsdata";
			...
			<Row className="row-sm">
				<Col sm={6} md={6} xl={3}>
					<Card className="custom-card">
						<Card.Body>
							<p className="mb-1 tx-inverse text-dark">Number Of Sales</p>
							<div>
								<h4 className="dash-25 mb-2">568</h4>
							</div>
							<div className="expansion-value d-flex tx-inverse text-dark">
								<strong>
				...
				<Col md={6} sm={6} xl={3}>
					<Card className="custom-card">
						<Card.Body>
							<p className="mb-1 tx-inverse text-dark">New Revenue</p>
							<div>
				...
				<Col md={6} sm={6} xl={3}>
					<Card className="custom-card">
						<Card.Body>
							<p className="mb-1 tx-inverse text-dark">Total Cost</p>
							<div>
				...
				<Col md={6} sm={6} xl={3}>
					<Card className="custom-card">
						<Card.Body>
							<p className="mb-1 tx-inverse text-dark">Profit By Sale</p>
							<div>
									...
									<Col sm={6} lg={6} className="border-end">
										<Card.Body className="iconfont text-center">
											...
											<p className="text-muted">
												...
												<span className="d-inline-flex ms-2"> in this year </span>
											</p>
							...
							<div className="card-block">
								...
								<ul className="task-list">
									<li>
										...
										<p className="text-muted fs-12">Adam Berry finished task on<Link href="#!" className="fw-medium"> Project Management</Link></p>
									</li>
									<li>
										<i className="task-icon bg-secondary"></i>
										<h6>New Comment<span className="float-end text-muted fs-11">25 Oct 2020</span></h6>
										<p className="text-muted fs-12">Victoria commented on Project <Link href="#!" className="fw-medium"> AngularJS Template</Link></p>
									</li>
									<li>
										<i className="task-icon bg-secondary"></i>
									...
									<li>
										...
										<p className="text-muted mb-0 fs-12">Petey Cruiser finished task <Link href="#!" className="fw-medium"> Integrated management</Link></p>
									</li>
								</ul>
							</div>
						</Card.Body>
					...
					<Card className="custom-card">
						...
						<Card.Body className="pt-2 mt-0">
							<div className="list-group border projects-list">
								<Link href="#!" className="list-group-item list-group-item-action flex-column border-end-0 border-start-0 align-items-start border-top-0">
								...
								<Link href="#!" className="list-group-item list-group-item-action flex-column border-end-0 border-start-0 align-items-start">
									<div className="d-flex w-100 justify-content-between">
								...
								<Link href="#!" className="list-group-item list-group-item-action border-end-0 border-start-0 flex-column align-items-start">
									<div className="d-flex w-100 justify-content-between">
								...
								<Link href="#!" className="list-group-item list-group-item-action flex-column border-end-0 border-bottom-0 border-start-0 align-items-start">
									<div className="d-flex w-100 justify-content-between">
