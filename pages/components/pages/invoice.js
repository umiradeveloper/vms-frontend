				...
				<Col lg={12} md={12}>
					<Card className="custom-card">
						<Card.Body>
							<div className="d-lg-flex">
								...
								<div className="ms-auto">
									<p className="mb-1"><span className="fw-semibold">Invoice Date :</span> 01st November 2020</p>
									<p className="mb-0"><span className="fw-semibold">Due Date :</span> 01 May  2020</p>
								</div>
							</div>
						...
						<Card.Footer className="text-end">
							<Button variant="primary" className="ripple  mb-1 me-2"> <i className="fe fe-credit-card me-1"></i> Pay Invoice </Button>
							<Button variant="secondary" className="ripple mb-1 me-2"><i className="fe fe-send me-1"></i> Send Invoice </Button>
							<Button variant="info" className="ripple  mb-1 me-2" onClick={() => { window.print(); }}><i className="fe fe-printer me-1"></i> Print Invoice </Button>
						</Card.Footer>
					</Card>
				</Col>
			</Row>
