...
const CreateExam = ({ openModal, setOpenModal, loader, setLoader, reload, setReload }) => {
    ...
    const HandleSubmit = async() => {
        ...
        try {
            const result = await apiConfig.post(apiUrl + "/UmiraTest/create-exam", fm, {
                headers: {
...
export default dynamic(() => Promise.resolve(CreateExam), { ssr: false });