...
import { Backgrounddata, Othercolors, Outlinedata } from "../../../shared/data/elements/colordata";
...
const Colors = () => {
	return (
		<Fragment>
			<Seo title={"Colors"} />
			<PageHeader title='Colors' item='Utilities' active_item='Colors' />
			<Row>
				<Col lg={12} sm={6}>
			...
			<Row>
				{Othercolors.map((idx) => (
					<Col xl={12} key={Math.random()}>
						<Card className="custom-card">
							<div className="card-body d-xl-flex flex-wrap">
