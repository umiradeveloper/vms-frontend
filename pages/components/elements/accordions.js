...
import { accordion1, accordion10, accordion11, accordion12, accordion13, accordion14, accordion15, accordion16, accordion2, accordion3, accordion4, accordion5, accordion6, accordion7, accordion8, accordion9 } from "../../../shared/data/prismdata/uielementsprim";
import PageHeader from "../../../shared/layout-components/page-header/page-header";

const Accordionsandcollapse = () => {
	//MULTIPLE TARGETS
	...
	return (
		<Fragment>
			<Seo title={"Accordionsandcollapse"} />
			<PageHeader title='Accordions' item='Elements' active_item='Accordions' />
			...
			<Row>
                ...
                parent container.
						...
						<Accordion className="accordion accordion-flush" id="accordionFlushExample" flush>
							<Accordion.Item eventKey='0'>
			...
			<Row>
				...
				<Col xl={6}>
					<ShowCode title="Multiple Targets Collapse" customCardClass="custom-card" customCardBodyClass="" code={accordion15}>
						<p className="mb-0">
...
Accordionsandcollapse.layout = "Contentlayout";
export default Accordionsandcollapse;
