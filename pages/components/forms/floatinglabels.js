...
const Floatinglabels = () => {
	...
	return (
		<>
			...
			<PageHeader title="Floating labels" item="Forms" active_item="Floating labels" />
			<Row>
				<Col xl={6}>
				...
				<Col xl={6}>
					<ShowCode title="Floating Labels With Pre Defined Values" customCardClass="custom-card" customCardBodyClass="" code={floating3}>
						...
						<form className="form-flotin">
							...
							<label htmlFor="floatingInputInvalid" className="mb-0">Invalid input</label>
						</form>
					</ShowCode>
				</Col>
				<Col xl={6}>
				...
				<Col xl={6}>
					<ShowCode title="Floating Labels With Layouts" customCardClass="custom-card" customCardBodyClass="" code={floating6}>
						<div className="row g-2">
							...
							<div className="col-md">
								<FloatingLabel controlId="floatingSelect" label="Works with selects">
									<Form.Select aria-label="Floating label select example" className='form-select' id='floatingSelectGrid'>
										<option>Open this select menu</option>
										<option value="1">One</option>
										<option value="2">Two</option>
										<option value="3">Three</option>
