								...
								<div className="">
									<div className="main-mail-menu">
										<nav className="nav main-nav-column mg-b-20">
											<Link className="nav-link active" href="/components/apps/mail/mailinbox/">
						...
						<Card className=" custom-card">
							...
							<Card.Footer className=" d-sm-flex rounded-0">
								<div className="">
									...
									>
										<i
											className="fe fe-paperclip btn px-2 border-0 fs-16"
									...
									>
										<i
											className="fe fe-link btn px-2 border-0 fs-16"
											data-bs-toggle="tooltip"
											title="Link"
									...
									>
										<i
											className="fe fe-image btn px-2 border-0 fs-16"
											data-bs-toggle="tooltip"
											title="Photos"
									...
									>
										<i
											className="fe fe-trash btn px-2 border-0 fs-16"
											data-bs-toggle="tooltip"
											title="Delete"
