...
const DetailScurvePlan = () => {
    ...
    const COLUMNS = [
        ...
        {
            Header: "Nominal Scurve",
            accessor: "nominal_scurve",
        },
        {
                ...
                const arrScurve = [];
                 for (const a of result.data.data) {
                    arrScurve.push({
                        ...
                        nominal_scurve: toCurrency(a.nominal_scurve),
                        dokumen_pendukung: (
                        ...
                        aksi: <div className="d-flex gap-2">
                            <button
                                ...
                                onClick={() => { deleteData(a.id_scurve) }}
                            >
                                Delete
                            </button>
                        </div>,
    ...
    return(
        <Fragment>
            <Seo title={"Detail S Curve"} />

            <PageHeaderVms title='S Curve' item='Daftar S Curve' active_item='Detail S Curve' />
            <LoadersSimUmira open={loader} />
            <CreateScurvePlan openModal={openModalCreate} setOpenModal={setOpenModalCreate} loader={loader} setLoader={setLoader} />
            ...
            <Row>
                <Col xl={12}>
                    <Card className="custom-card">
                        <Card.Header>
                            <div className="card-title">Detail S Curve </div>
                        </Card.Header>
...
DetailScurvePlan.layout = "ContentlayoutVms";

export default DetailScurvePlan;
