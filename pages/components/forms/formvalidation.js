...
import { validation1, validation2, validation3, validation4, validation5 } from "../../../shared/data/prismdata/formsdata";
...
const Validation = () => {
	...
	return (
		<>
			...
			<PageHeader title="Validation" item="Forms" active_item="Validation" />
			<Row>
				<Col xl={6}>
					...
					<ShowCode title="Supported elements" customCardClass="custom-card" customCardBodyClass="" code={validation5}>
						<Form className="was-validated">
							...
							<Form.Group className="mb-3" >
								...
								<Form.Control.Feedback className="invalid-feedback">Example invalid select feedback</Form.Control.Feedback>
							</Form.Group>

							<div className="mb-3">
								<Form.Control type="file" aria-label="file example"
									required />
								<Form.Control.Feedback className="invalid-feedback">Example invalid form file feedback</Form.Control.Feedback>
							</div>
