...
import { Colorheaderalerts, Colredalerts, Defaultalerts, Dismissiblealerts } from "../../../shared/data/elements/popoversdata";
import Link from "next/link";
import ShowCode from "../../../shared/showcode/showcode";
import { popovers1, popovers2, popovers3, popovers4, popovers5, popovers6, popovers7, popovers8 } from "../../../shared/data/prismdata/uielementsprim";
...
const Popovers = () => {
	...
	return (
		<>
			<Seo title={"Popovers"} />
			<PageHeader title='Popovers' item='Elements' active_item='Popovers' />
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Dismissible Popovers" customCardClass="custom-card" customCardBodyClass="d-flex flex-wrap justify-content-between" code={popovers5}>
