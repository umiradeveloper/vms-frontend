...
import { Row, Card, Col, ListGroup, ListGroupItem, Dropdown, Collapse, Modal, Button } from "react-bootstrap";
				...
				<Col xxl={3} xl={6} lg={6} md={6} sm={12}>
					...
					<Card className=" custom-card">
						...
						<Card.Footer className="">
							<Link href="#!" class="card-link text-danger m-1">Buy Now</Link>
							<Link href="#!" class="card-link text-success m-1"><u>Review</u></Link>
						</Card.Footer>
					</Card>
				</Col>
				<Col xxl={3} xl={6} lg={6} md={6} sm={12}>
								...
								<Col xxl={4} xl={4} lg={4} md={4} sm={4}>
									<Card className=" custom-card">
										<ListGroup as="ul" className="list-group list-group-flush">
											<ListGroupItem as="li" className="list-group-item">Featured</ListGroupItem>
											<ListGroupItem as="li" className="list-group-item">An item</ListGroupItem>
											<ListGroupItem as="li" className="list-group-item">A second item</ListGroupItem>
											<ListGroupItem as="li" className="list-group-item">A third item</ListGroupItem>
										</ListGroup>
									</Card>
								</Col>
								<Col xxl={4} xl={4} lg={4} md={4} sm={4}>
						...
						<div className="col">
							<Card className=" custom-card">
								<Card.Body >
									...
									<Link href="#!" className="btn btn-primary">Purchase</Link>
								</Card.Body>
							</Card>
						</div>
						<div className="col">
							<Card className=" custom-card">
								<Card.Body >
									...
									<p className="card-text">With supporting text below as a natural
										lead-in to additional content.</p>
									<Link href="#!" className="btn btn-secondary">Purchase</Link>
								</Card.Body>
							</Card>
						</div>
						<div className="col">
							<Card className="card custom-card">
								<Card.Body >
									...
									<p className="card-text">With supporting text below as a natural
										lead-in to additional content.</p>
									<Link href="#!" className="btn btn-light">Purchase</Link>
								</Card.Body>
							</Card>
						</div>
					</Row>
			...
			<Row >
					...
					<Card className=" custom-card">
						<Card.Header >
							<div className="d-flex align-items-center w-100">
								...
								<Dropdown className="dropdown ms-auto no-caret">
									<Dropdown.Toggle variant='' aria-label="anchor" href="#!" className="btn btn-icon btn-sm btn-light no-caret" data-bs-toggle="dropdown">
				...
				<Col xl={3}>
					<Card className=" custom-card text-center">
						<Card.Header className=" border-bottom-0 pb-0">
							<span className="float-end shadow-lg fs-17"><i className="ri-heart-fill text-danger"></i></span>
						</Card.Header>
				...
				<Col xl={3}>
					<Card className=" custom-card text-center">
						...
						<Card.Body >
							...
							<Link href="#!" className="btn btn-primary mt-2 me-1">Read More</Link>
					...
					{Basicshow ?
						<Card className="custom-card">
							<div className="card-header justify-content-between">
								...
								<Link aria-label="anchor" href="#!" onClick={() => setBasicshow(false)}>
				...
				<Col xl={4}>
					<Card className="custom-card">
						<Card.Header className="justify-content-between">
							...
							<Link aria-label="anchor" href="#!" data-bs-toggle="card-fullscreen" onClick={() => handleShow(true)}>
							...
							<Modal show={fullscreenshow} fullscreen={fullScreen} onHide={() => setfullscreenShow(false)}>
								<Modal.Header>
									...
									<span className="d-flex ms-auto" onClick={fullscreenmodalClose}><i className='fe fe-x ms-auto lh-1' ></i></span>
								</Modal.Header>
				...
				<Col xl={4}>
					<Card className=" custom-card overlay-card">
						...
						<div className="card-img-overlay d-flex flex-column p-0">
							<Card.Header >
								<div className="card-title text-fixed-white  pb-3">
									Image Overlays Are Awesome!
								</div>
							</Card.Header>
							<Card.Body className=" text-fixed-white overflow-scroll">
					...
					<Card className=" custom-card card-bg-light">
						<Card.Body >
							<div className="d-flex align-items-center w-100">
								...
								<div className="ms-auto">
									<Link href="#!" className="text-default"><i className="bi bi-three-dots-vertical"></i></Link>
								</div>
							</div>
						</Card.Body>
					</Card>
					...
					<Card className=" custom-card card-bg-dark">
						<Card.Body >
							<div className="d-flex align-items-center w-100">
								...
								<div className="ms-auto">
									<Link href="#!" className="text-white"><i className="bi bi-three-dots-vertical"></i></Link>
								</div>
							</div>
						</Card.Body>
					</Card>
