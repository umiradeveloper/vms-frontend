	...
	constructor(props) {
		...
		this.state = {
			...
			options: {
				...
				colors: ["var(--primary-color)", "#01b8ff", "#f5b849"],
				stroke: {
					show: true,
					width: 2,
					colors: ["transparent"]
	...
	constructor(props) {
		...
		this.state = {
			...
			options: {
				...
				colors: ["#6259ca", "#01b8ff", "#f5b849", "#fd7889"],
				responsive: [{
					// breakpoint: 480,
					options: {
						legend: {
	...
	constructor(props) {
		...
		this.state = {
			...
			options: {
				...
				colors: ["var(--primary-color)", "#01b8ff"],
				plotOptions: {
					bar: {
						horizontal: false
					}
...
const colors = ["#6259ca", "#01b8ff", "#f5b849", "#49b6f5", "#fd7889", "#26bf94", "#5b67c7"];
...
export class Loaded extends Component {
	constructor(props) {
		...
		this.state = {
			...
			colors: ["var(--primary-color)", "#6259ca", "#f5b849", "#49b6f5", "#fd7889", "#26bf94", "#5b67c7"],
			options: {
				chart: {
					id: "barYear",
					height: 400,
	...
	constructor(props) {
		...
		this.state = {
			...
			options: {
				...
				colors: ["var(--primary-color)", "#01b8ff", "#f5b849", "#49b6f5", "#fd7889", "#26bf94", "#5b67c7", "#a65e76"],
				plotOptions: {
					bar: {
						columnWidth: "45%",
						distributed: true,
