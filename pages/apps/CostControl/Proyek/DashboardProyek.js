                                ...
                                <Col xl={4}>
                                    <Card className="custom-card">
                                        <Card.Body>
                                            ...
                                            <div className={`badge ${(calcPercentage(calcBkAfterMos(p.total_bk, (p.proyek.mos.length>0)?p.proyek.mos[0].nominal_mos:0), p.total_pu) <= calcbkpuawal(p.proyek.biaya_rap ,calcRabAkhir(p.proyek.biaya_rab, p.kerja_kurang, p.kerja_tambah))) ?"bg-success": "bg-danger" }`}><h5>BK/PU Saat Ini : {formatPercent(calcPercentage(calcBkAfterMos(p.total_bk, (p.proyek.mos.length>0)?p.proyek.mos[0].nominal_mos:0), p.total_pu))}</h5></div>
                                        </Card.Body>
