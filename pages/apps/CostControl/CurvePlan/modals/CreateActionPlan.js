...
const CreateActionPlan = ({openModal, setOpenModal, loader, setLoader}) => {
    ...
    const submit = async() => {
        ...
        formData.append("nominal_action_plan", valueNominalPuClean);
    ...
    return(
        <Modal size="md" show={openModal.open_modal} onHide={() => setOpenModal({ ...openModal, open_modal: false })} className="fade" id="exampleModal" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <Modal.Header closeButton>
                <h6 className="modal-title" id="exampleModalLabel">Tambah Action Plan</h6>
            </Modal.Header>
                        ...
                        <Row>
                            <Col xl={12} className="rounded-3">
                                <div className="row gy-2 pb-3">
                                    ...
                                    <Col xl={12}>
                                        <label htmlFor="pendapatan-usaha" className="form-label ">Nominal Action Plan <span style={{ color: "red" }}>*</span> :</label>
                                        <input type="text" className={`form-control`} id="nominal_pu" placeholder="Nominal Action Plan" onChange={handleNominalScurve} value={dataCreate.nominal_scurve} />
                                    </Col>
                                    <Col xl={12}>
                                        <label className="form-label mt-3">
...
export default dynamic(() => Promise.resolve(CreateActionPlan), { ssr: false });