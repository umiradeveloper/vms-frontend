                        ...
                        <div className="header-element">
                            <div className="horizontal-logo">
                                <Link className="header-logo " href={"/apps/DashboardVms"}>
                                    <img src={`${process.env.NODE_ENV === "production" ? basePath : ""}/assets/images/brand-logos/logo-umira-a.png`} alt="logo" className="desktop-logo" />
                                    <img src={`${process.env.NODE_ENV === "production" ? basePath : ""}/assets/images/brand-logos/logo-umira-a.png`} alt="logo" className="toggle-logo" />
                                    <img src={`${process.env.NODE_ENV === "production" ? basePath : ""}/assets/images/brand-logos/logo-umira-a.png`} alt="logo" className="desktop-dark" />
                                    <img src={`${process.env.NODE_ENV === "production" ? basePath : ""}/assets/images/brand-logos/logo-umira-a.png`} alt="logo" className="toggle-dark" />
                                    <img src={`${process.env.NODE_ENV === "production" ? basePath : ""}/assets/images/brand-logos/logo-umira-a.png`} alt="logo" className="desktop-white" />
                                    <img src={`${process.env.NODE_ENV === "production" ? basePath : ""}/assets/images/brand-logos/logo-umira-a.png`} alt="logo" className="toggle-white" />
                                </Link>
                            </div>
                        </div>
                    ...
                    <div className="header-content-right">
                        ...
                        <Dropdown className="header-element header-profile">
                            ...
                            <Dropdown.Menu className="main-header-dropdown pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end">
                                <div className="header-navheading border-bottom pb-3">
                                    <div className="header-link-icon">
                                        <img src={`${process.env.NODE_ENV === "production" ? basePath : ""}/assets/images/faces/1.jpg`} alt="img" width="32" height="32" className="rounded-circle" />
                                    </div>
                                    <h6 className="main-notification-title mt-3">{namaUser}</h6>
                                    <p className="main-notification-text mb-0">{role}</p>
                                </div>
                
                                <Dropdown.Item as="button" onClick={handleLogout}><i className="fe fe-power fs-16 align-middle me-2"></i>Log Out</Dropdown.Item>
                            </Dropdown.Menu>
                        </Dropdown>
                        {/* Right sidebar */}
