...
const CreateEmployee = ({openModal, setOpenModal, loader, setLoader}) => {
    ...
    const submitData = async() => {
        ...
        // console.log(dataSubmit)
        try {
            const result = await apiConfig.post(apiUrl + "/HR-Employee/create-employee", dataEmployee,{
                headers: {
                    "Content-Type": "application/json",
                    "Authorization": "Bearer " + localStorage.getItem("token")
                }
    ...
    return(
        <Modal size="xl" show={openModal.open} onHide={() => {setOpenModal({...openModal, open: false})}}> 
            <Modal.Header>
                <h6 className="modal-title" id="exampleModalLabel">Tambah Employee</h6>
            </Modal.Header>
            <Modal.Body>
                 <Row>
                    <Col xl={12}>
                        ...
                        <div className="row gy-2 pb-3">
                            ...
                            <Col xl={12}>
                                ...
                                {/* <input type="text" value={dataEmployee.grade} className={`form-control`} id="grade" placeholder="Grade" onChange={(e) => setDataEmployee({...dataEmployee, grade: e.target.value})}/> */}
                                    <Select name="state"  className="basic-multi-select " options={optionGradeKelas} isSearchable
                    ...
                    <Col xl={6} className="rounded-3">
                        ...
                        />
                            ...
                            <Col xl={12}>
                                 ...
                                 */}
                                 <Select name="state"  className="basic-multi-select " options={optionJenisKelamin} isSearchable
                            ...
                            <Col xl={12}>
                                ...
                                <Select name="state"  className="basic-multi-select " options={optionPtkp} isSearchable
