import { radio1, radio10, radio11, radio12, radio13, radio14, radio15, radio16, radio17, radio18, radio19, radio2, radio20, radio21, radio22, radio23, radio24, radio3, radio4, radio5, radio6, radio7, radio8, radio9 } from "../../../../shared/data/prismdata/formsdata";
				...
				<Col xl={6} lg={6} md={6} sm={12} className="">
					<ShowCode title="Toggle Switch-2 Sizes" customCardClass="custom-card" customCardBodyClass="" code={radio19}>
						<div className="d-flex align-items-center flex-wrap mb-4">
							<div className=""><p className="text-muted">Small size toggle switch <code>toggle-sm</code></p></div>
						...
						<div className="d-flex align-items-center flex-wrap mb-4">
							<div className=""><p className="text-muted">Default toggle switch</p></div>
						...
						<div className="d-flex  align-items-center flex-wrap">
							<div className="mb-sm-0 mb-2"><p className="text-muted">Large size toggle switch <code>toggle-lg</code></p></div>
...
Checks$radios.layout = "Contentlayout";
