...
import { toast1, toast10, toast2, toast3, toast4, toast5, toast6, toast7, toast8, toast9 } from "../../../shared/data/prismdata/uielementsprim";
						...
						<ToastContainer className="toast-container position-fixed top-0 end-0 p-3">
							<Toast id="liveToast" className="toast fade show" role="alert" aria-live="assertive" aria-atomic="true" onClose={() => setShow(false)} show={show} delay={3000} autohide>
								<Toast.Header className="text-default">
									...
									<strong className="me-auto">spruha</strong> <small>11 mins ago</small>
								</Toast.Header>
