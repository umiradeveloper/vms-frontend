...
import Themeprimarycolor, * as switcherdata from "../../data/switcher/switcherdata";
				...
				<div className="offcanvas-body">
					<Tab.Container id="left-tabs-example" defaultActiveKey="ThemeStyles">
						<nav className="border-bottom border-block-end-dashed">
							<Nav variant="pills" className="nav nav-tabs nav-justified switcher-main-tabs" id="switcher-main-tab" role="tablist">
								<Nav.Item className='mb-0'>
									<Nav.Link className="p-0" eventKey="ThemeStyles"> <button className="nav-link" id="switcher-home-tab" data-bs-toggle="tab" data-bs-target="#switcher-home"
										type="button" role="tab" aria-controls="switcher-home" aria-selected="true">Theme Styles</button></Nav.Link>
								</Nav.Item>
								<Nav.Item className='mb-0'>
									<Nav.Link className="p-0" eventKey="ThemeColors"> <button className="nav-link" id="switcher-profile-tab" data-bs-toggle="tab" data-bs-target="#switcher-profile"
						...
						<Tab.Content className="tab-content " id="nav-tabContent">
							...
							<Tab.Pane eventKey="ThemeStyles" className="p-0 border-0" id="switcher-home" role="tabpanel" aria-labelledby="switcher-home-tab"
								tabIndex={0}>
								<div className="">
							...
							<Tab.Pane eventKey="ThemeColors" className="p-0 border-0" id="switcher-profile" role="tabpanel" aria-labelledby="switcher-profile-tab" tabIndex={0}>
								<div>
							...
							<div className="d-flex justify-content-between canvas-footer flex-wrap">
								<Link href="#!" id="reset-all" onClick={() => switcherdata.Reset(ThemeChanger)} className="w-100 btn btn-danger m-1">Reset</Link>
							</div>
						</Tab.Content>
					</Tab.Container>
				</div>
