					...
					<Row>
						...
						<Col xl={12}>
							<Card className="custom-card">
								...
								<Card.Body>
									<p><Link href="#!" className="pe-none" tabIndex={-1} aria-disabled="true"><code className="text-primary fw-semibold me-1 d-inline-flex">This link</code></Link>
										can
										not be clicked.
									</p>
									<p><Link href="#!" className="pe-auto"><code className="text-primary fw-semibold me-1 d-inline-flex">This link</code></Link>can be clicked (this is default
										behavior).
									</p>
									<p className="pe-none mb-0"><Link href="#!" tabIndex={-1} aria-disabled="true" className='me-1 d-inline-flex'><code>This link</code></Link>
										can
										not be clicked because the <code className="text-primary fw-semibold">pointer-events</code> property is inherited
										from its parent. However, <Link href="#!" className="pe-auto d-inline-flex">this link</Link> has a
					...
					<Card className="custom-card">
						...
						<Card.Body>
							...
							<div
								...
								<div className="h-50 text-center d-sm-inline-block d-none p-2"
									style={{ width: "120px", backgroundColor: "rgba(0,0,255,.1)" }}
								>Height 50%
								</div>
								<div className="h-75 text-center d-inline-block p-2"
									style={{ width: "120px", backgroundColor: "rgba(0,0,255,.1)" }}
								>Height 75%
								</div>
								<div className="h-100 text-center d-inline-block p-2"
									style={{ width: "120px", backgroundColor: "rgba(0,0,255,.1)" }}
								>Height 100%
								</div>
								<div className="h-auto text-center d-inline-block p-2"
									style={{ width: "120px", backgroundColor: "rgba(0,0,255,.1)" }}
								>Height auto
								</div>
							</div>
					...
					<Card className="custom-card">
						...
						<Card.Body>
							...
							<div
								...
								className="mt-3">
								<div className="mh-100 text-center p-2"
