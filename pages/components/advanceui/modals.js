...
import { Button, Card, CloseButton, Col, Container, Form, Modal, OverlayTrigger, Row, Tooltip, Popover } from "react-bootstrap";
import Rodal from "rodal";
import "rodal/lib/rodal.css";
import Link from "next/link";
import Seo from "../../../shared/layout-components/seo/seo";
import ShowCode from "../../../shared/showcode/showcode";
import { modal1, modal10, modal11, modal12, modal13, modal14, modal2, modal3, modal4, modal5, modal6, modal7, modal8, modal9 } from "../../../shared/data/prismdata/advanceuidata";
import PageHeader from "../../../shared/layout-components/page-header/page-header";

const Modalsandcloses = () => {
	...
	return (
		<Fragment>
			<Seo title={"Modalsandcloses"} />
			<PageHeader title='Modal & Closes' item='Advanced Ui' active_item='Modal & Closes' />
			...
			<Row>
				...
				<Col xl={4}>
					<ShowCode title=" Tooltips and popovers " customCardClass="custom-card" customCardHeaderClass="" customCardBodyClass="" code={modal6}>
						...
						<Modal show={show3} onHide={handleClose3} centered className='popover-modal' id="exampleModalScrollable4" aria-labelledby="exampleModalScrollable4" data-bs-keyboard="false"
							...
							<Modal.Footer>
								<Button variant='' type="button" className="btn btn-secondary" onClick={handleClose3}
									data-bs-dismiss="modal">Close</Button>
								<Button variant='' type="button" className="btn btn-primary">Save
									Changes</Button>
							</Modal.Footer>
			...
			<Row>
				<Col xl={4}>
					<ShowCode title="Using the grid" customCardClass="custom-card" customCardHeaderClass="" customCardBodyClass="" code={modal7}>
						...
						<Modal show={modalShow2} onHide={() => setModalShow2(false)} centered>
							...
							<Modal.Footer>
								<Button variant='secondary' type="button" className="" onClick={() => setModalShow2(false)}
									data-bs-dismiss="modal">Close</Button>
				...
				<Col xl={4}>
					<ShowCode title="Optional sizes" customCardClass="custom-card" customCardHeaderClass="" customCardBodyClass="" code={modal9}>
						...
						<Button variant='' type="button" className="btn btn-primary-light m-1" data-bs-toggle="modal" onClick={() => setLgShow(true)}
							data-bs-target="#exampleModalLg">Large modal</Button>
						<Button variant='' type="button" className="btn btn-primary-light m-1" data-bs-toggle="modal" onClick={() => setSmShow(true)}
							...
							<Row className="row-sm">
								...
								<Col sm={6} md={4} xl={3} className="">
									...
									<Rodal onClose={() => viewDemoClose1("show2")} visible={animation2} animation='fade' height={330}>
										<h6 className='modal-header'>Message Preview
											<Link href='#!'><span className="d-flex ms-auto text-dark" onClick={() => { viewDemoClose1("show2"); }}></span></Link>
										</h6>
										<div className='modal-body'>
											<h6>Why We Use Electoral College, Not Popular Vote</h6>
											It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English.</div>
								...
								<Col sm={6} md={4} xl={3} className="">
									...
									<Rodal onClose={() => viewDemoClose1("show3")} visible={animation3} animation='flip' height={330}>
										<h6 className='modal-header'>Message Preview
											<Link href='#!'><span className="d-flex ms-auto text-dark" onClick={() => { viewDemoClose1("show3"); }}></span></Link>
										</h6>
										<div className='modal-body'>
											<h6>Why We Use Electoral College, Not Popular Vote</h6>
											It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English.</div>
								...
								<Col sm={6} md={4} xl={3} className="">
									...
									<Rodal onClose={() => viewDemoClose1("show4")} visible={animation4} animation='door' height={330}>
										<h6 className='modal-header'>Message Preview
											<Link href='#!'><span className="d-flex ms-auto text-dark" onClick={() => { viewDemoClose1("show4"); }}></span></Link>
										</h6>
										<div className='modal-body'>
											<h6>Why We Use Electoral College, Not Popular Vote</h6>
											It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English.</div>
								...
								<Col sm={6} md={4} xl={3} className="">
									...
									<Rodal onClose={() => viewDemoClose1("show5")} visible={animation5} animation='rotate' height={330}>
										<h6 className='modal-header'>Message Preview
											<Link href='#!'><span className="d-flex ms-auto text-dark" onClick={() => { viewDemoClose1("show5"); }}></span></Link>
										</h6>
										<div className='modal-body'>
											<h6>Why We Use Electoral College, Not Popular Vote</h6>
											It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English.</div>
								...
								<Col sm={6} md={4} xl={3} className="">
									...
									<Rodal onClose={() => viewDemoClose1("show6")} visible={animation6} animation='slideUp' height={330}>
										<h6 className='modal-header'>Message Preview
											<Link href='#!'><span className="d-flex ms-auto text-dark" onClick={() => { viewDemoClose1("show6"); }}></span></Link>
										</h6>
										<div className='modal-body'>
											<h6>Why We Use Electoral College, Not Popular Vote</h6>
											It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English.</div>
								...
								<Col sm={6} md={4} xl={3} className="">
									...
									<Rodal onClose={() => viewDemoClose1("show7")} visible={animation7} animation='slideDown' height={330}>
										<h6 className='modal-header'>Message Preview
											<Link href='#!'><span className="d-flex ms-auto text-dark" onClick={() => { viewDemoClose1("show7"); }}></span></Link>
										</h6>
										<div className='modal-body'>
											<h6>Why We Use Electoral College, Not Popular Vote</h6>
											It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English.</div>
								...
								<Col sm={6} md={4} xl={3} className="">
									...
									<Rodal onClose={() => viewDemoClose1("show8")} visible={animation8} animation='slideLeft' height={330}>
										<h6 className='modal-header'>Message Preview
											<Link href='#!'><span className="d-flex ms-auto text-dark" onClick={() => { viewDemoClose1("show8"); }}></span></Link>
										</h6>
										<div className='modal-body'>
											<h6>Why We Use Electoral College, Not Popular Vote</h6>
											It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English.</div>
								...
								<Col sm={6} md={4} xl={3} className="">
									...
									<Rodal onClose={() => viewDemoClose1("show9")} visible={animation9} animation='slideRight' height={330}>
										<h6 className='modal-header'>Message Preview
											<Link href='#!'><span className="d-flex ms-auto text-dark" onClick={() => { viewDemoClose1("show9"); }}></span></Link>
										</h6>
										<div className='modal-body'>
											<h6>Why We Use Electoral College, Not Popular Vote</h6>
											It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English.</div>
			...
			<Row>
				...
				<Col xl={4}>
					<ShowCode title="White variant" customCardClass="custom-card overflow-hidden" customCardHeaderClass="pb-2" customCardBodyClass="bg-black" code={modal14}>
...
Modalsandcloses.layout = "Contentlayout";
export default Modalsandcloses;
