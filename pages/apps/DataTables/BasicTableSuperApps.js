...
export const GlobalFilterSuperApps = ({ filter, setFilter }) => {
	return (
...
const BasicTableSuperApps = ({column, datatable}) => {
	...
	return (
		<>
			<div className="d-flex">
				...
				<GlobalFilterSuperApps filter={globalFilter} setFilter={setGlobalFilter} />
			</div>
			<table
				{...getTableProps()}
...
export default dynamic(() => Promise.resolve(BasicTableSuperApps), { ssr: false });
