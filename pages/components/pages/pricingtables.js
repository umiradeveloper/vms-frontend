...
import { Nav, Card, Tab, Row, Col } from "react-bootstrap";
				...
				<Col xxl={3} md={6} sm={12}>
					<Card className="custom-card pricingTable2">
						...
						<div className="pricing-plans  bg-primary">
							<span className="price-value1"> <i className="fa fa-usd"></i> <span>0.00</span> </span>
						...
						<div className="pricingTable2-sign-up">
							<Link href="#!" className="btn btn-block btn-primary"> sign up </Link>
						</div>
					</Card>
				</Col>
				<Col xxl={3} md={6} sm={12}>
									...
									>
										<Nav as='ul' variant="pills" className="justify-content-center nav-price">
											<Nav.Item as='li' className="me-0">
												<Nav.Link eventKey="first" className="rounded-end-0">Year</Nav.Link>
											</Nav.Item>
											<Nav.Item as='li'>
												<Nav.Link eventKey="second" className="rounded-start-0">Month</Nav.Link>
											</Nav.Item>
										</Nav>
										...
										<Tab.Content className="px-0">
											<Tab.Pane eventKey="first">
												<Row className="row-sm">
													<Col sm={6} xxl={3} className=" mg-t-10 mg-lg-t-0">
														<Card className="overflow-hidden">
															<div className="text-center card-pricing pricing1">
																<div className="p-2 text-fixed-white bg-primary fs-20">
																	Free
																</div>
													...
													<Col sm={6} xxl={3} className=" mg-t-10 mg-lg-t-0">
														<Card className="overflow-hidden">
															<div className="text-center card-pricing pricing1">
																<div className="p-2 text-fixed-white bg-secondary fs-20">
																	Personal
																</div>
																<div className="p-3 font-weight-normal mb-0">
																	<span className="price">$99</span>
													...
													<Col sm={6} xxl={3} className=" mg-t-10 mg-lg-t-0">
														<Card className="overflow-hidden">
															<div className="text-center card-pricing pricing1">
																<div className="p-2 text-fixed-white bg-info fs-20">
																	Premium
																</div>
																<div className="p-3 font-weight-normal mb-0">
													...
													<Col sm={6} xxl={3} className=" mg-t-10 mg-lg-t-0">
														<Card className="overflow-hidden">
															<div className="text-center card-pricing pricing1">
																<div className="p-2 text-fixed-white bg-success fs-20">
																	Enterprise
																</div>
																<div className="p-3 font-weight-normal mb-0">
