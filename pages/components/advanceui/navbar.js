...
const Navbar1 = () => {
	...
	return (
		<Fragment>
			<Seo title={"Navbar"} />
			<PageHeader title='Navbar' item='Advanced Ui' active_item='Navbar' />
			{/* <!-- Row1 --> */}
			<Row>
				<Col xl={12}>
				...
				<Col xl={12}>
					<Card className="custom-card">
						...
						<Card.Body>
							...
							<Navbar className="navbar bg-light mb-3">
								<Container fluid className="d-block d-sm-flex">
					...
					<Card className="custom-card">
						...
						<Card.Body>
							<Navbar expand="lg" className="navbar navbar-expand-lg navbar-primary mb-3">
								<Container fluid>
									<Navbar.Brand href="#!">
										<img src="../../../assets/images/brand-logos/toggle-white.png" alt="" />
									</Navbar.Brand>
									<Navbar.Toggle aria-controls="basic-navbar-nav" />
									<Navbar.Collapse className="collapse navbar-collapse" id="navbarColor04">
										...
										<form className="d-flex" role="search">
											<Form.Control className="form-control me-2 border-0" type="search" placeholder="Search"
												aria-label="Search" />
											<Button variant='' className="btn bg-light"
												type="submit">Search</Button>
										</form>
									</Navbar.Collapse>
								</Container>
							...
							<Navbar expand="lg" className="navbar navbar-expand-lg navbar-secondary mb-3">
								<Container fluid>
									<Navbar.Brand href='#!'>  <img src="../../../assets/images/brand-logos/toggle-white.png" alt="" /></Navbar.Brand>
									<Navbar.Toggle aria-controls="basic-navbar-nav" />
