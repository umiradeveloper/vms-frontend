...
const DetailApprovalPengajuan = ({ openModal, setOpenModal, loader, setLoader }) => {
    ...
    //             }
    //             const approvalProyek = [];
    //             if(datas.detailPersetujuanProyek.length > 0){
    //                 for await (const approval of datas.detailPersetujuanProyek){
    //                     const imgQr = await digitalSign(approval.id_persetujuan)
    //                     console.log(imgQr);
    //                     approvalProyek.push({
    //                         id_persetujuan: approval.id_persetujuan ?? "-",
    //                         nama_persetujuan: approval.nama_persetujuan ?? "-",
    //                         tanggal_persetujuan: approval.tanggal_persetujuan ?? "-",
    //                         status_approver: approval.status_approver ?? "-",
    //                         qrCode: imgQr.image,
    //                     })
    //                 }
    //             }
    ...
    //                 pengajuanTransaksi: approvalProyek,
    //                 detailPayment: datas.detailPayment,
    //                 transaksi_via: datas.transaksi_via,
    //             })
    ...
    //     const apiUrl = process.env.NEXT_PUBLIC_API_URL;
    //     try {
    //         const resultApi = await apiConfig.get(apiUrl + "/ChecklistTransaksi/transaksi/Proyek/digital-sign", {
    //              params: {
    //                 text: text
    //             },
    //             responseType: "blob",
    ...
    //             }
    //         });
    //         return{status: true, image: resultApi, message: null};
    //     }catch(error){
    //         // console.log(error);
    //         return{status: false, image: null, message: error};
    //     }finally{
    //         setLoader(false);
    //     }
    // }
