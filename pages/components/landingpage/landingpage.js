							...
							<div className="container main-banner-container">
								<Row>
									<Col xl={6} lg={6} className="animation-zidex position-relative">
										...
										<p className="text-start fw-bold">We Help to Build Your Dream Project with Spruha !</p>
										<h6 className="pb-3">
											Spruha-JS  Now you can use this Nextjs admin template to design stunning dashboards
											that will wow your target viewers or users to no end. To create a good and
											well-structured dashboard,
											you need to start from scratch with Nextjs, SCSS, CSS, and JS and with lots of coding,
											but by using this Spruha-JS Admin template.</h6>
					...
					<section className="section hor-content main_features" id="features">
						<Container>
							<div>
								...
								<h2 className="fw-medium text-center">Spruha-JS NextJs Main Features</h2>
										...
										<Card className="features border text-center main-features main-features-1 wow fadeInUp "
											...
											<Card.Body>
												...
												<div className="text-left counter-body">
													...
													<p className="mb-0">Spruha-JS has a unique design that you cannot compare with any other templates. It has unique Design</p>
												</div>
											</Card.Body>
										</Card>
									</Col>
										...
										<Card className="features border text-center main-features main-features-2 wow fadeInUp"
											...
											<Card.Body>
												...
												<div className="text-left counter-body">
													...
													<p className="mb-0">The Spruha-JS admin code is maintained very cleanly and
									...
									<Col lg={3} md={6}>
										<Card className="features border text-center main-features main-features-6 wow fadeInUp reveal revealleft"
											...
											<Card.Body>
												...
												<div className="text-left counter-body">
													<h4 className="fw-bold">Modern NextJs Widgets</h4>
													<p className="mb-0">
					...
					<section className="section highlights" id="highlights">
						<Container className="text-center">
							<Row>
								...
								<h2 className="text-center fw-medium">Switch Easily From Vertical to Horizontal Menu</h2>
							</Row>
							<Row className="justify-content-center">
								<Col xl={7}>
									<p className="fs-15 mb-5 fw-normal">The Spruha–JS NextJs-bootstrap Admin & Dashboard
							...
							<div className="p-2 mb-0">
								<Card.Body className="p-0">
									...
									<footer className="main-footer px-0 text-center">
										<Row>
											<Col md={12} sm={12}> Copyright © <span id="year">{new Date().getFullYear()}</span> <Link href="#!">Spruha</Link>.Designed with <span className="fa fa-heart text-danger"></span> by <Link href="#!"> Spruko </Link> All rights reserved.</Col>
										</Row>
									</footer>
								</Card.Body>
							</div>
