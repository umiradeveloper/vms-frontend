...
// Your Table9data array
const checked = <input className="form-check-input" type="checkbox" value="" id="checkebox-sm" />
const defaultChecked = <input className="form-check-input" type="checkbox" value="" id="checkebox-sm" defaultChecked />
export const Table9data = [
	{ id: "1", name: "Zelensky", date: "25-Apr-2021", text: "Paid", class: "success-transparent", check: defaultChecked},
	{ id: "2", name: "Kim Jong", date: "29-April-2022", text: "Pending", class: "danger-transparent",check: checked },
	{ id: "3", name: "Obama", date: "30-Nov-2022", text: "Paid", class: "success-transparent",check: checked },
	{ id: "4", name: "Sean Paul", date: "01-Jan-2022", text: "Paid", class: "success-transparent" ,check: checked},
	{ id: "5", name: "Karizma", date: "14-Feb-2022", text: "Pending", class: "danger-transparent" ,check: checked}
];
...
export const  Table11data =[
	...
	{id:9, text:"Dark", color:"dark", quantity:"35", price:"$1,832",  class1:"table-dark",class2:"text-white",name:"Polly Pipe", bgcolor:"table-dark"}
];
