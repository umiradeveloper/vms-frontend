import { input1, input2, input3, input4, input5, input6, input7, input8 } from "../../../../shared/data/prismdata/formsdata";
					...
					<ShowCode title="Input Types" customCardClass="custom-card" customCardBodyClass="" code={input1}>
						<div className="row gy-4">
							<Col xl={4} lg={6} md={6} sm={12}>
								<Form.Label htmlFor="input-label">Basic Input:</Form.Label>
							...
							<Col xl={4} lg={6} md={6} sm={12}>
								...
								<Form.Control type="button" className="form-control btn btn-primary text-fixed-white" id="input-button" defaultValue="Button" />
							</Col>
							<Col xl={4} lg={6} md={6} sm={12}>
								<Row>
									<Col xl={3}>
