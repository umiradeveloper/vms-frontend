...
const DaftarProyekBk = () => {
            ...
            if(result.status == 200){
                ...
                for await (const data of result.data.data) {
                    daftarArr.push({
                        ...
                        tanggal_awal_kontrak: formatdate(data.proyek.tanggal_akhir_kontrak),
    ...
    return(
        <Fragment>
            ...
            <PageHeaderVms title='Daftar Proyek Biaya Kontruksi' item='Biaya Kontruksi' active_item='Daftar Proyek' />
