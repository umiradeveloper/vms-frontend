...
const CreatePu = () => {
    ...
    return (
        <Fragment>
            <Seo title={"Input Pendapatan Usaha"} />
            <PageHeaderVms title="Pendapatan Usaha" item="Cost Control" active_item="Pendapatan Usaha" />
            <LoadersSimUmira open={loader} />
            <Row>
                <Col xl={12}>
                    <ShowCode title="Pendapatan Usaha" customCardClass="custom-card" customCardBodyClass="" >
                        <Row>
